...
postRouter.get('/', indexValidator, validationHandler, postsController.index);
postRouter.get('/:id', authMiddleware, showValidator, validationHandler, postsController.show);
