...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      includeAssets: [ // 로컬 경로의 이미지 참조 // public의 icons 안 all
        '/icons/*'
      ],
      manifest: {
        name: 'saragram',  // PWA 애플리케이션의 이름 (설치 배너에 표시)
        short_name: 'saragram', // 홈 화면 아이콘 아래에 표시될 이름
        description: 'welcome to saragram!', // 앱 설명
